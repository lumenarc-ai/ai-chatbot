...
import { createDataStream, smoothStream, streamText, type UIMessage } from "ai";
 ...
 */
export async function processChatWithdemoGraphTools({
  messages,
  selectedChatModel,
  requestHints,
  session,
          ...
          experimental_activeTools:
            selectedChatModel === "chat-model-reasoning"
              ...
              : [
                  ...
                  // You can dynamically get these from demoGraphTools: Object.keys(demoGraphTools)
                ],
 ...
 * import { processChatWithdemoGraphTools } from '@/lib/services/demo-graph/chat-integration-example';
 *
 * export async function POST(request: Request) {
 *   // ... existing code to parse request and validate session
 *
 *   const stream = await processChatWithdemoGraphTools({
 *     messages,
 *     selectedChatModel,
 *     requestHints,
 *     session,
